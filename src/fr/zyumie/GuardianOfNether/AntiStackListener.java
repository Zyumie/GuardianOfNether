...
public class AntiStackListener implements Listener {
     ...
     * S'exécute AVANT le SpawnListener normal (qui utilise la priorité par défaut NORMAL)
     */
    ...
    /**
     * Alternative: Bloquer directement lors de tentatives de merge
     * Utilise également HIGHEST pour s'exécuter en premier
     */
    @EventHandler(priority = EventPriority.HIGHEST, ignoreCancelled = true)
